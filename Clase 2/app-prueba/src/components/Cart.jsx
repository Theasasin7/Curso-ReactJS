...

                {
                    cart.map((item) => (
                        <div className="flex flex-col items-center">
                            <div className=" flex flex-row p-2 gap-2 bg-gray-500 w-max m-5 border-2 border-gray-700" key={item.id}>
                                    ...
                                    <img className="flex border-2 border-gray-900 mt-2 w-56" src={item.img} alt={item.name}></img>
                                        <div className="flex flex-col">
                                            <div className="flex flex-col justify-center items-center font-semibold ml-4 border-2 border-gray-500 mt-2 space-y-2">
                                                ...
                                                <button className="flex justify-center w-10 border-2 h-8 items-center border-blue-500 bg-blue-400 rounded-full" onClick={() => clearItem(item.id)}>
                                                    <BsFillTrashFill />
                                                </button>
                                            </div>
                                        </div>
